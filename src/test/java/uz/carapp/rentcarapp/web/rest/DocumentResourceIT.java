...
import static uz.carapp.rentcarapp.domain.DocumentAsserts.*;
...
class DocumentResourceIT {
    ...
    private static final DocTypeEnum DEFAULT_DOC_TYPE = DocTypeEnum.BIO_PASSPORT;
    private static final DocTypeEnum UPDATED_DOC_TYPE = DocTypeEnum.ID_CARD;
    ...
    private static final Boolean DEFAULT_DOC_STATUS = false;
    private static final Boolean UPDATED_DOC_STATUS = true;
    ...
    void partialUpdateDocumentWithPatch() throws Exception {
        ...
        partialUpdatedDocument.name(UPDATED_NAME).givenDate(UPDATED_GIVEN_DATE).issuedDate(UPDATED_ISSUED_DATE);
