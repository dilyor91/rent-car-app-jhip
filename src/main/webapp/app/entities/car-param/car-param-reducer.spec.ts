...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_CARPARAM_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches SEARCH_CARPARAMS actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_CARPARAM actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_CARPARAM actions', async () => {
      const arg = { id: 17346 };
    ...
    it('dispatches UPDATE_CARPARAM actions', async () => {
      const arg = { id: 17346 };
    ...
    it('dispatches PARTIAL_UPDATE_CARPARAM actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_CARPARAM actions', async () => {
      const arg = 42666;
