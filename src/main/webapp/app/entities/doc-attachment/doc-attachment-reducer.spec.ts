...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_DOCATTACHMENT_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches SEARCH_DOCATTACHMENTS actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_DOCATTACHMENT actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_DOCATTACHMENT actions', async () => {
      const arg = { id: 28471 };
    ...
    it('dispatches UPDATE_DOCATTACHMENT actions', async () => {
      const arg = { id: 28471 };
    ...
    it('dispatches PARTIAL_UPDATE_DOCATTACHMENT actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_DOCATTACHMENT actions', async () => {
      const arg = 42666;
