...
import reducer, {
  ...
  searchEntities,
  updateEntity,
} from './car-template-param.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_CARTEMPLATEPARAM_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches SEARCH_CARTEMPLATEPARAMS actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_CARTEMPLATEPARAM actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_CARTEMPLATEPARAM actions', async () => {
      const arg = { id: 17175 };
    ...
    it('dispatches UPDATE_CARTEMPLATEPARAM actions', async () => {
      const arg = { id: 17175 };
    ...
    it('dispatches PARTIAL_UPDATE_CARTEMPLATEPARAM actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_CARTEMPLATEPARAM actions', async () => {
      const arg = 42666;
