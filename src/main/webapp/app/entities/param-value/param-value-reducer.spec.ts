...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_PARAMVALUE_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches SEARCH_PARAMVALUES actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_PARAMVALUE actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_PARAMVALUE actions', async () => {
      const arg = { id: 17213 };
    ...
    it('dispatches UPDATE_PARAMVALUE actions', async () => {
      const arg = { id: 17213 };
    ...
    it('dispatches PARTIAL_UPDATE_PARAMVALUE actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_PARAMVALUE actions', async () => {
      const arg = 42666;
