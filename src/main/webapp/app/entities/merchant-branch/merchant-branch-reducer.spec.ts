...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_MERCHANTBRANCH_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches SEARCH_MERCHANTBRANCHES actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_MERCHANTBRANCH actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_MERCHANTBRANCH actions', async () => {
      const arg = { id: 24775 };
    ...
    it('dispatches UPDATE_MERCHANTBRANCH actions', async () => {
      const arg = { id: 24775 };
    ...
    it('dispatches PARTIAL_UPDATE_MERCHANTBRANCH actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_MERCHANTBRANCH actions', async () => {
      const arg = 42666;
