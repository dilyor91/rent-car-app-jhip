...
import { getEntities, searchEntities } from './translation.reducer';
  ...
  return (
    <div>
      <h2 id="translation-heading" data-cy="TranslationHeading">
        <Translate contentKey="rentcarappjhipApp.translation.home.title">Translations</Translate>
        <div className="d-flex justify-content-end">
          <Button className="me-2" color="info" onClick={handleSyncList} disabled={loading}>
            <FontAwesomeIcon icon="sync" spin={loading} />{' '}
            <Translate contentKey="rentcarappjhipApp.translation.home.refreshListLabel">Refresh List</Translate>
          </Button>
          <Link to="/translation/new" className="btn btn-primary jh-create-entity" id="jh-create-entity" data-cy="entityCreateButton">
            <FontAwesomeIcon icon="plus" />
            &nbsp;
            <Translate contentKey="rentcarappjhipApp.translation.home.createLabel">Create new Translation</Translate>
          </Link>
        </div>
      </h2>
      <Row>
            ...
            <FormGroup>
              <InputGroup>
                <Input
                  ...
                  placeholder={translate('rentcarappjhipApp.translation.home.search')}
                />
        ...
        {translationList && translationList.length > 0 ? (
            ...
            <thead>
              <tr>
                <th className="hand" onClick={sort('id')}>
                  <Translate contentKey="rentcarappjhipApp.translation.id">ID</Translate>{' '}
            ...
            <tbody>
              {translationList.map((translation, i) => (
                <tr key={`entity-${i}`} data-cy="entityTable">
                  ...
                  <td>
                    <Translate contentKey={`rentcarappjhipApp.LanguageEnum.${translation.lang}`} />
                  </td>
                  ...
                  <td className="text-end">
                    <div className="btn-group flex-btn-group-container">
                      ...
                      <Button
                        tag={Link}
                        to={`/translation/${translation.id}/edit?page=${paginationState.activePage}&sort=${paginationState.sort},${paginationState.order}`}
                        color="primary"
                        size="sm"
                      ...
                      <Button
                        onClick={() =>
                          (window.location.href = `/translation/${translation.id}/delete?page=${paginationState.activePage}&sort=${paginationState.sort},${paginationState.order}`)
                        }
                        color="danger"
                        size="sm"
          ...
          !loading && (
            <div className="alert alert-warning">
              <Translate contentKey="rentcarappjhipApp.translation.home.notFound">No Translations found</Translate>
            </div>
          )
        )}
      </div>
