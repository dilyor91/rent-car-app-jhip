...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_CARCLASS_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches SEARCH_CARCLASSES actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_CARCLASS actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_CARCLASS actions', async () => {
      const arg = { id: 1523 };
    ...
    it('dispatches UPDATE_CARCLASS actions', async () => {
      const arg = { id: 1523 };
    ...
    it('dispatches PARTIAL_UPDATE_CARCLASS actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_CARCLASS actions', async () => {
      const arg = 42666;
