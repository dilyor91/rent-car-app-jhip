...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_CARATTACHMENT_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches SEARCH_CARATTACHMENTS actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_CARATTACHMENT actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_CARATTACHMENT actions', async () => {
      const arg = { id: 4474 };
    ...
    it('dispatches UPDATE_CARATTACHMENT actions', async () => {
      const arg = { id: 4474 };
    ...
    it('dispatches PARTIAL_UPDATE_CARATTACHMENT actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_CARATTACHMENT actions', async () => {
      const arg = 42666;
