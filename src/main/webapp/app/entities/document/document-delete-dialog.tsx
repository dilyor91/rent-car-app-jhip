...
export const DocumentDeleteDialog = () => {
  ...
  return (
    <Modal isOpen toggle={handleClose}>
      ...
      <ModalBody id="rentcarappjhipApp.document.delete.question">
        <Translate contentKey="rentcarappjhipApp.document.delete.question" interpolate={{ id: documentEntity.id }}>
