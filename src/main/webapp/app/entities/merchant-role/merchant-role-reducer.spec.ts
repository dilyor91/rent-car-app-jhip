...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_MERCHANTROLE_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches SEARCH_MERCHANTROLES actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_MERCHANTROLE actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_MERCHANTROLE actions', async () => {
      const arg = { id: 14072 };
    ...
    it('dispatches UPDATE_MERCHANTROLE actions', async () => {
      const arg = { id: 14072 };
    ...
    it('dispatches PARTIAL_UPDATE_MERCHANTROLE actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_MERCHANTROLE actions', async () => {
      const arg = 42666;
