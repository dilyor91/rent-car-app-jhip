...
import { deleteEntity, getEntity } from './model.reducer';
...
export const ModelDeleteDialog = () => {
  ...
  return (
    <Modal isOpen toggle={handleClose}>
      ...
      <ModalBody id="rentcarappjhipApp.model.delete.question">
        <Translate contentKey="rentcarappjhipApp.model.delete.question" interpolate={{ id: modelEntity.id }}>
