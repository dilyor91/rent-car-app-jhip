...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_PARAMETR_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches SEARCH_PARAMETRS actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_PARAMETR actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_PARAMETR actions', async () => {
      const arg = { id: 16223 };
    ...
    it('dispatches UPDATE_PARAMETR actions', async () => {
      const arg = { id: 16223 };
    ...
    it('dispatches PARTIAL_UPDATE_PARAMETR actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_PARAMETR actions', async () => {
      const arg = 42666;
