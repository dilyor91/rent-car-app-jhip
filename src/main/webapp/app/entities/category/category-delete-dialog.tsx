...
export const CategoryDeleteDialog = () => {
  ...
  return (
    <Modal isOpen toggle={handleClose}>
      ...
      <ModalBody id="rentcarappjhipApp.category.delete.question">
        <Translate contentKey="rentcarappjhipApp.category.delete.question" interpolate={{ id: categoryEntity.id }}>
