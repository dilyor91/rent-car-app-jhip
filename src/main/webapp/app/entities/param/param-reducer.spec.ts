...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_PARAM_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches SEARCH_PARAMS actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_PARAM actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_PARAM actions', async () => {
      const arg = { id: 12650 };
    ...
    it('dispatches UPDATE_PARAM actions', async () => {
      const arg = { id: 12650 };
    ...
    it('dispatches PARTIAL_UPDATE_PARAM actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_PARAM actions', async () => {
      const arg = 42666;
