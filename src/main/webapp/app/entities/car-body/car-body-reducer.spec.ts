...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_CARBODY_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches SEARCH_CARBODIES actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_CARBODY actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_CARBODY actions', async () => {
      const arg = { id: 22936 };
    ...
    it('dispatches UPDATE_CARBODY actions', async () => {
      const arg = { id: 22936 };
    ...
    it('dispatches PARTIAL_UPDATE_CARBODY actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_CARBODY actions', async () => {
      const arg = 42666;
