...
import reducer, {
  ...
  searchEntities,
  updateEntity,
} from './merchant-document.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_MERCHANTDOCUMENT_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches SEARCH_MERCHANTDOCUMENTS actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_MERCHANTDOCUMENT actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_MERCHANTDOCUMENT actions', async () => {
      const arg = { id: 32721 };
    ...
    it('dispatches UPDATE_MERCHANTDOCUMENT actions', async () => {
      const arg = { id: 32721 };
    ...
    it('dispatches PARTIAL_UPDATE_MERCHANTDOCUMENT actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_MERCHANTDOCUMENT actions', async () => {
      const arg = 42666;
