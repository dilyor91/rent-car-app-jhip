...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_CARMILEAGE_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches SEARCH_CARMILEAGES actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_CARMILEAGE actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_CARMILEAGE actions', async () => {
      const arg = { id: 24042 };
    ...
    it('dispatches UPDATE_CARMILEAGE actions', async () => {
      const arg = { id: 24042 };
    ...
    it('dispatches PARTIAL_UPDATE_CARMILEAGE actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_CARMILEAGE actions', async () => {
      const arg = 42666;
