  ...
  return (
    <div>
      <h2 id="attachment-heading" data-cy="AttachmentHeading">
        <Translate contentKey="rentcarappjhipApp.attachment.home.title">Attachments</Translate>
        <div className="d-flex justify-content-end">
          <Button className="me-2" color="info" onClick={handleSyncList} disabled={loading}>
            <FontAwesomeIcon icon="sync" spin={loading} />{' '}
            <Translate contentKey="rentcarappjhipApp.attachment.home.refreshListLabel">Refresh List</Translate>
          </Button>
          <Link to="/attachment/new" className="btn btn-primary jh-create-entity" id="jh-create-entity" data-cy="entityCreateButton">
            <FontAwesomeIcon icon="plus" />
            &nbsp;
            <Translate contentKey="rentcarappjhipApp.attachment.home.createLabel">Create new Attachment</Translate>
          </Link>
        </div>
      </h2>
      <Row>
            ...
            <FormGroup>
              <InputGroup>
                <Input
                  ...
                  placeholder={translate('rentcarappjhipApp.attachment.home.search')}
                />
        ...
        {attachmentList && attachmentList.length > 0 ? (
            ...
            <thead>
              <tr>
                <th className="hand" onClick={sort('id')}>
                  <Translate contentKey="rentcarappjhipApp.attachment.id">ID</Translate>{' '}
                ...
                <th className="hand" onClick={sort('ext')}>
                  <Translate contentKey="rentcarappjhipApp.attachment.ext">Ext</Translate>{' '}
                  <FontAwesomeIcon icon={getSortIconByFieldName('ext')} />
                </th>
                <th />
              </tr>
            </thead>
          ...
          !loading && (
            <div className="alert alert-warning">
              <Translate contentKey="rentcarappjhipApp.attachment.home.notFound">No Attachments found</Translate>
            </div>
          )
        )}
      </div>
