...
export const AttachmentDeleteDialog = () => {
  ...
  return (
    <Modal isOpen toggle={handleClose}>
      ...
      <ModalBody id="rentcarappjhipApp.attachment.delete.question">
        <Translate contentKey="rentcarappjhipApp.attachment.delete.question" interpolate={{ id: attachmentEntity.id }}>
