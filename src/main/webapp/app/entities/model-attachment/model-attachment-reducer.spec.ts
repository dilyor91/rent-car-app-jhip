...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_MODELATTACHMENT_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches SEARCH_MODELATTACHMENTS actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_MODELATTACHMENT actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_MODELATTACHMENT actions', async () => {
      const arg = { id: 19620 };
    ...
    it('dispatches UPDATE_MODELATTACHMENT actions', async () => {
      const arg = { id: 19620 };
    ...
    it('dispatches PARTIAL_UPDATE_MODELATTACHMENT actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_MODELATTACHMENT actions', async () => {
      const arg = 42666;
