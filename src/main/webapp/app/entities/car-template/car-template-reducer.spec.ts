...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_CARTEMPLATE_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches SEARCH_CARTEMPLATES actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_CARTEMPLATE actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_CARTEMPLATE actions', async () => {
      const arg = { id: 17982 };
    ...
    it('dispatches UPDATE_CARTEMPLATE actions', async () => {
      const arg = { id: 17982 };
    ...
    it('dispatches PARTIAL_UPDATE_CARTEMPLATE actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_CARTEMPLATE actions', async () => {
      const arg = 42666;
